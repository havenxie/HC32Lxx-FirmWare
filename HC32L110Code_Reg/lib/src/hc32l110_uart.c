...
void UART0_Test(void)
{
    ...
    RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIO, ENABLE);  //使能GPIO的时钟
	RCC_AHBPeriphClockCmd(RCC_AHBPeriph_UART0, ENABLE);//使能USART的时钟
    
    GPIO_InitStructure.GPIO_Pin = GPIO_PinSource5 | GPIO_PinSource6;
    ...
    /* USART0的端口配置 */
	GPIO_PinAFConfig(GPIO3, GPIO_PinSource5, GPIO_AF_3);//配置P35成第二功能引脚	TX
	GPIO_PinAFConfig(GPIO3, GPIO_PinSource6, GPIO_AF_3);//配置P36成第二功能引脚  RX
    
    /* USART0的基本配置 */
	USART_InitStructure.USART_BaudRate = 115200;              //波特率
	USART_InitStructure.USART_WordLength = USART_WordLength_8b;
	USART_InitStructure.USART_RECEN = USART_RECEN_TxRx;
	USART_InitStructure.USART_Mode = USART_MODE1;
