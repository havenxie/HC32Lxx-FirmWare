...
#ifndef __HC32L110_RCC_H
#define __HC32L110_RCC_H
#include "hc32lxx.h"
#ifdef __cplusplus
 extern "C" {
#endif
...
#define RCC_AHBPeriph_UART0              RCC_AHBENR_UART0
#define RCC_AHBPeriph_UART1              RCC_AHBENR_UART1
#define RCC_AHBPeriph_LPUART             RCC_AHBENR_LPUART
#define RCC_AHBPeriph_I2C                RCC_AHBENR_I2C
#define RCC_AHBPeriph_SPI                RCC_AHBENR_SPI
#define RCC_AHBPeriph_BASETIME           RCC_AHBENR_BASETIME
#define RCC_AHBPeriph_LPTIME             RCC_AHBENR_LPTIME
#define RCC_AHBPeriph_ADVTIME            RCC_AHBENR_ADVTIME
#define RCC_AHBPeriph_PCA                RCC_AHBENR_PCA
#define RCC_AHBPeriph_WDT                RCC_AHBENR_WDT
#define RCC_AHBPeriph_ADC                RCC_AHBENR_ADC
#define RCC_AHBPeriph_VC                 RCC_AHBENR_VC
#define RCC_AHBPeriph_RTC                RCC_AHBENT_RTC
#define RCC_AHBPeriph_CLKTRIM            RCC_AHBENR_CLKTRIM
#define RCC_AHBPeriph_BOOT               RCC_AHBENR_BOOT
#define RCC_AHBPeriph_SYSTICK            RCC_AHBENR_SYSYTICK
#define RCC_AHBPeriph_SWD                RCC_AHBENR_SWD
#define RCC_AHBPeriph_CRC                RCC_AHBENR_CRC
#define RCC_AHBPeriph_GPIO               RCC_AHBENR_GPIO
#define RCC_AHBPeriph_FLASH              RCC_AHBENR_FLASH
