...
** History:
**
**   - 2017-05-11  0.1   First version for Device Driver Library of Module.
**
******************************************************************************/
...
typedef struct
{
    __IO uint32_t RESULT_HIGH               :12;
} stc_adc_ht_field_t;

typedef struct
{
    __IO uint32_t RESULT_LOW                :12;
} stc_adc_lt_field_t;
...
typedef struct
{
    __IO uint32_t OPT2_5                    : 4;
    __IO uint32_t OPT1_5                    : 4;
    __IO uint32_t CLK_DELAY                 : 3;
    __IO uint32_t VCM_S                     : 2;
    __IO uint32_t PRE_S                     : 2;
    __IO uint32_t VREFTRIM                  : 1;
    __IO uint32_t CLK_SEL_EXT               : 1;
    __IO uint32_t CLK_S                     : 1;
    __IO uint32_t CLK_TEST                  : 1;
} stc_adc_cr3_field_t;
...
typedef struct
{
    __IO uint32_t GCMA_D                    :16;
} stc_adt_gcmar_field_t;

typedef struct
{
    __IO uint32_t GCMB_D                    :16;
} stc_adt_gcmbr_field_t;

typedef struct
{
    __IO uint32_t GCMC_D                    :16;
} stc_adt_gcmcr_field_t;

typedef struct
{
    __IO uint32_t GCMD_D                    :16;
...
typedef struct
{
    ...
    __IO uint32_t DIR                       : 1;
    __IO uint32_t FODIR                     : 1;
    uint32_t RESERVED10                     : 5;
    __IO uint32_t PBODIS                    : 1;
    __IO uint32_t ZMSKREV                   : 1;
    __IO uint32_t ZMSKPOS                   : 1;
    __IO uint32_t ZMSK                      : 2;
    uint32_t RESERVED20                     : 4;
    __IO uint32_t LEVA                      : 2;
    __IO uint32_t LEVSA                     : 1;
    __IO uint32_t FOLEVA                    : 1;
    __IO uint32_t LEVB                      : 2;
    __IO uint32_t LEVSB                     : 1;
    __IO uint32_t FOLEVB                    : 1;
...
typedef struct
{
    ...
    __IO uint32_t HOLDF                     : 2;
    uint32_t RESERVED26                     : 2;
    __IO uint32_t ODISRQ0                   : 1;
...
typedef struct
{
    ...
    __IO uint32_t FLASH_PARA_AADJ           : 1;
...
typedef struct
{
    ...
    __IO uint32_t WAKEUP_DPSP_MODE          : 1;
} stc_clock_wakeup_dpsp_field_t;
...
{
    __IO uint32_t TME                       : 1;
} stc_i2c_i2ctmrun_field_t;

typedef struct
{
    __IO uint32_t TM                        : 8;
} stc_i2c_i2ctm_field_t;
...
typedef struct
{
    ...
    __IO uint32_t STA                       : 1;
    __IO uint32_t ENS                       : 1;
} stc_i2c_i2ccon_field_t;

typedef struct
{
    __IO uint32_t I2CDAT                    : 8;
} stc_i2c_i2cdat_field_t;

typedef struct
{
    __IO uint32_t GC                        : 1;
    __IO uint32_t I2CADR                    : 7;
} stc_i2c_i2cadr_field_t;

typedef struct
{
    __IO uint32_t I2CSTA                    : 8;
} stc_i2c_i2csta_field_t;
...
typedef struct
{
    ...
    __IO uint32_t SPI                       : 1;
    uint32_t RESERVED7                      : 1;
    __IO uint32_t TMR012                    : 1;
    __IO uint32_t LPTMR                     : 1;
    __IO uint32_t ADVTMR                    : 1;
    uint32_t RESERVED11                     : 3;
    __IO uint32_t PCA                       : 1;
    __IO uint32_t WDT                       : 1;
    __IO uint32_t ADC                       : 1;
...
} stc_spi_spcon_field_t;

typedef struct
{
    __IO uint32_t SSN                       : 1;
} stc_spi_spssn_field_t;
...
} stc_spi_spsta_field_t;

typedef struct
{
    __IO uint32_t SPDAT                     : 8;
} stc_spi_spdat_field_t;
...
typedef struct
{
    ...
    __IO uint32_t INV_TIMER4                : 1;
    __IO uint32_t TM4                       : 1;
    __IO uint32_t INV_TIMER5                : 1;
    __IO uint32_t TM5                       : 1;
    __IO uint32_t INV_TIMER6                : 1;
    __IO uint32_t TM6                       : 1;
...
typedef struct
{
    ...
    {
        __IO uint32_t GPROR;
        stc_adt_gpror_field_t GPROR_f;
    };
    uint8_t RESERVED25[108];
    union
    {
        __IO uint32_t INTFR;
        stc_adt_intfr_field_t INTFR_f;
    };
    union
    {
        __IO uint32_t INTCR;
        stc_adt_intcr_field_t INTCR_f;
    };
    union
    {
        __IO uint32_t CTRLR;
        stc_adt_ctrlr_field_t CTRLR_f;
    };
...
typedef struct
{
    ...
    union
    {
        ...
        stc_clock_wakeup_dpsp_field_t WAKEUP_DPSP_f;
    };
    union
    {
...
typedef struct
{
    ...
    {
        __IO uint32_t P0STA;
        stc_gpio_p0sta_field_t P0STA_f;
    };
    ...
    {
        __IO uint32_t P1STA;
        stc_gpio_p1sta_field_t P1STA_f;
    };
    ...
    {
        __IO uint32_t P2STA;
        stc_gpio_p2sta_field_t P2STA_f;
    };
    ...
    {
        __IO uint32_t P3STA;
        stc_gpio_p3sta_field_t P3STA_f;
    };
...
typedef struct
{
    union
    {
        __IO uint32_t I2CTMRUN;
        stc_i2c_i2ctmrun_field_t I2CTMRUN_f;
    };
    union
    {
        __IO uint32_t I2CTM;
        stc_i2c_i2ctm_field_t I2CTM_f;
    };
    union
    {
        __IO uint32_t I2CCON;
        stc_i2c_i2ccon_field_t I2CCON_f;
    };
    union
    {
        __IO uint32_t I2CDAT;
        stc_i2c_i2cdat_field_t I2CDAT_f;
    };
    union
    {
        __IO uint32_t I2CADR;
        stc_i2c_i2cadr_field_t I2CADR_f;
    };
    union
    {
        __IO uint32_t I2CSTA;
        stc_i2c_i2csta_field_t I2CSTA_f;
    };
}M0P_I2C_TypeDef;
...
typedef struct
{
    ...
    {
        __IO uint32_t SPCON;
        stc_spi_spcon_field_t SPCON_f;
    };
    union
    {
        __IO uint32_t SPSSN;
        stc_spi_spssn_field_t SPSSN_f;
    };
    union
    {
        __IO uint32_t SPSTA;
        stc_spi_spsta_field_t SPSTA_f;
    };
    union
    {
        __IO uint32_t SPDAT;
        stc_spi_spdat_field_t SPDAT_f;
    };
}M0P_SPI_TypeDef;
...
typedef struct
{
    ...
    union
    {
        __IO uint32_t WDTRST;
        stc_wdt_wdtrst_field_t WDTRST_f;
    };
    union
    {
        __IO uint32_t WDTCON;
        stc_wdt_wdtcon_field_t WDTCON_f;
    };
}M0P_WDT_TypeDef;
...
#define M0P_CRC                                ((M0P_CRC_TypeDef *)0x40020800UL)
...
#define M0P_LPTIMER                            ((M0P_LPTIMER_TypeDef *)0x40000600UL)
...
#define M0P_WDT                                ((M0P_WDT_TypeDef *)0x40000600UL)
